...
#                print("success_x_hist", success_x_hist)
                arr_success_x_hist = np.array(success_x_hist)
#                print("arr_success_x_hist", arr_success_x_hist)
                avg_success_x_hist_list.append(arr_success_x_hist)
#                print("avg_success_x_hist_list", avg_success_x_hist_list)
                x_data_success_hist.append(avg_success_x_hist_list)
#                print("x_data_success_hist", x_data_success_hist)
                arr_x_data_success_hist = np.array(x_data_success_hist)
#                print("arr_x_data_success_hist", arr_x_data_success_hist)
...
#                print("fail_x_hist", fail_x_hist)
                arr_fail_x_hist = np.array(fail_x_hist)
#                print("arr_fail_x_hist", arr_fail_x_hist)
                avg_fail_x_hist_list.append(arr_fail_x_hist)
#                print("avg_fail_x_hist_list", avg_fail_x_hist_list)
                x_data_fail_hist.append(avg_fail_x_hist_list)
#                print("x_data_fail_hist", x_data_fail_hist)
                arr_x_data_fail_hist = np.array(x_data_fail_hist)
#                print("arr_x_data_fail_hist", arr_x_data_fail_hist)
